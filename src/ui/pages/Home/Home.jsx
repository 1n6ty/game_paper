...
export default function Home() {
  ...
  const factoryHistory = (
    <div className="card-text">
      Здесь вы можете рассказать о своем заводе, о своих ценностях, об этапах развития. 
      <br/>
      Это точно сделает вас ближе к клиентам!
    </div>);
    ...
    <div className="home-container">
      ...
      >
        <div className="home-card-text">
          <b>Сканируй код «Честный знак» на упаковках нашей продукции и получай ламбиксы! </b>
